...
public class WebEvents {
	 ...
	 * 
	 * @param locator  by locator is to find the element
	 * @param timeouts max timeout if element is not found
	 ...
	 * 
	 * @param by               locator which is to find element
	 * @param timeoutinseconds max time to wait if element is not found
	 * @throws Element_Is_Not_Clicked_Exception if element is not found not able to
	 *                                          click on element it throws element
	 *                                          is not cliked exception
	 */
	 ...
	 * 
	 * @param by               locator is to find the element
	 * @param input            is a value which is to enter in text field
	 * @param timeoutinseconds max time out wait if element is not displayed
	 * @throws ValueNotEnterdIntoTextFieldException if input is not entered in text
	 *                                              field it throws a value not
	 ...
	 * @param timeoutinseconds max time to wait if element is not found
	 * @throws CheckBoxNotSelectedException if element is not found ,not able to
	 *                                      click on the element it throws
	 *                                      CheckBoxNotSelectedException
	 */
	 ...
	 * 
	 * @param by               locator is to find the element
	 * @param valuetoselect    the value which is to select from listbox
	 * @param timeoutinseconds max time to wait untill the element is displyed
	 * @throws ValueNotSelectedInListboxException if the value is not found in list
	 *                                            box it throws
